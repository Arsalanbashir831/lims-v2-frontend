    ...
    <div className="flex flex-col gap-2 md:flex-row items-center justify-between md:px-2 py-2">
      ...
      <div className="flex items-center justify-between space-x-6 lg:space-x-8 w-full md:w-auto">
        <div className="flex items-center space-x-2">
          ...
          >
            <SelectTrigger className="text-xs md:text-sm px-2 py-0.5 !h-fit md:px-3 md:py-2 md:h-8 w-[50px] md:w-[70px]">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button variant="outline" size="icon" className="size-6 md:size-8" onClick={() => table.previousPage()} disabled={!table.getCanPreviousPage()}>
            <span className="sr-only">Go to previous page</span>
            <ChevronLeft />
          </Button>
          <Button variant="outline" size="icon" className="size-6 md:size-8" onClick={() => table.nextPage()} disabled={!table.getCanNextPage()}>
