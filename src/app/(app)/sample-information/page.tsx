...
export default function SampleInformationPage() {
    ...
    const columns: ColumnDef<any>[] = useMemo(() => [
        ...
        },
        {
            ...
            cell: ({ row }) => <span className="max-w-[150px] truncate">{row.original.end_user || "N/A"}</span>,
        },
        {
    ...
    return (
        <DataTable
            ...
            onRowClick={(row) => router.push(ROUTES.APP.SAMPLE_INFORMATION.EDIT(String(row.original.job_id)))}
            toolbar={toolbar}
            footer={footer}
        />
    )
